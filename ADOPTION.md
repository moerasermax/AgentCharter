...
> **版本對齊**：本檔對應 charter `v0.7.5`（依 [versioning-migration.md](./core/versioning-migration.md) §1）
...
讀 [README.md](./README.md) → 選 preset → 在 profile.yaml 固定 `charter_version: "0.7.5"`（或當前最新版）。
...
- [ ] `_config/profile.yaml` 含 `charter_version: "0.7.5"`（或當前最新版）+ 選定 preset
