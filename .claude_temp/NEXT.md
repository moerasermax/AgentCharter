...
> **更新時間**：2026-05-22（**v0.12.0 ship — 3 in 1 BREAKING-MEDIUM** — (1) Antigravity vendor 接入完成 + (2) **Canonical Init Spec Layer ship**（SSS S2.5、架構級概念第 15 個、dogfood signal #61 條款化）+ (3) **agents-commons rename**（BREAKING-MEDIUM、`agent-commons/` → `agents-commons/`、架構級概念第 14 個 `core/vendor-lifecycle.md` 收編 #5/#41/#55/#58/#59/#60 family）。架構級概念 13 → 15、條款數 25 → 27）
