...
> **更新時間**：2026-04-30（台灣時間，post-v0.8.2 release 收尾 snapshot）
> **當前版本**：v0.8.2（雙軸矩陣 framing 第一段 — README §設計哲學第 5 條「雙軸座標 — 哪些紀律靠誰守」+ 21 條 core 條款補雙軸標籤 blockquote 段、**嚴守向下兼容**、**dogfood-driven hardening 第十六循環**）
> **Working tree 狀態**：v0.8.2 修訂完成、待 commit + push
> **GitHub**：https://github.com/moerasermax/AgentCharter（private）
> **最後 checkpoint**：本檔為 v0.7.5 release 前 snapshot（含深度 sweep）
> **Git tags**：`v0.5.9` @ `a24c15c` / `pre-v0.6.0-batch` @ `2225659` / `v0.5.10` @ `6dd3eda` / `v0.6.0` @ `9493814` / `v0.6.1` @ `72caaee` / `v0.7.0` @ `bcbf964` / `v0.7.1` @ `c26b5b4` / `v0.7.2` @ `054e6c7` / `v0.7.3` @ `0468570` / `v0.7.4` @ `130638b` / `v0.7.5` (待打) / `v0.8.0` @ `b5866b5` / `v0.8.1` @ `0cf5494` (待打) / `v0.8.2` (待打)
