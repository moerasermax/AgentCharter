...
> **更新時間**：2026-05-06（台灣時間，post-v0.10.4 ship — Vendor 介紹 charter 工具紀律 charter common 化）
> **當前版本**：**v0.10.4**（**PATCH — Vendor 介紹 charter 工具紀律 charter common 化**、對齊 v0.7.3 北極星「不讓 user 為了用一個工具還要查 charter 文件」、零採用方動作要求）
